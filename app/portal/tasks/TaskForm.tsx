...
export default function TaskForm() {
  ...
  return (
    <form action={createChecklistTask} className="flex flex-col gap-4 sm:flex-row sm:items-end">
      ...
      <button
        type="submit"
        className="flex-shrink-0 bg-[#3b82f6] text-white dark:bg-[#3b82f6] dark:text-white rounded-2xl px-4 py-2 text-sm font-medium shadow-md transition-all hover:scale-105 hover:opacity-90 active:scale-95 sm:mb-2"
      >
        Add Task
      </button>
    </form>
