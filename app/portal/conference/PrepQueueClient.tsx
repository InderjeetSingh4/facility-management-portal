          ...
          <div className="w-full max-w-sm rounded-3xl border border-border bg-surface p-6 shadow-sm backdrop-blur-xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isPending}
                className="w-full bg-[#3b82f6] text-white dark:bg-[#3b82f6] dark:text-white rounded-2xl px-4 py-2 text-sm font-medium shadow-md transition-all hover:scale-105 hover:opacity-90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
              >
