  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Brand */}
        <div className="text-[15px] font-[800] tracking-[0.08em] text-[#1e2a5e] dark:text-accent mb-[90px] relative z-10">
          FACILITY PORTAL
        </div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-[13px] text-[#9aa3b8] dark:text-text-muted leading-[1.5] max-w-[260px] mb-[46px]">
            Welcome back — sign in to your facility management system.
          </p>

          {/* Form */}
          <form action={formAction} className="space-y-[26px]">
            
            {/* Email Field */}
            <div className="max-w-[260px] group relative">
              <label className="block text-[13px] text-[#6b7590] dark:text-text-muted mb-[8px] transition-colors group-focus-within:text-[#2148c4] dark:group-focus-within:text-accent">
                Email
              </label>
            ...
            <div className="max-w-[260px] group relative">
              ...
              <div className="relative border border-transparent bg-black/5 dark:bg-bg-surface-raised rounded-[10px] p-4 focus-within:border-[#2148c4] focus-within:border-dashed dark:focus-within:border-accent transition-colors flex items-center">
                ...
                <button
                  ...
                  className="absolute right-4 text-[#9aa3b8] hover:text-[#6b7590] dark:text-text-muted dark:hover:text-text-primary transition-colors"
          ...
          <div className="mt-[18px] text-[13px] text-[#9aa3b8] dark:text-text-muted">
            ...
            <Link href="/signup" className="font-[700] text-[#2148c4] dark:text-accent hover:underline transition-all">
              Sign up
            </Link>
          </div>
        </div>
